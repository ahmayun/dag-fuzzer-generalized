...
autonode_8 = autonode_10.distinct()
autonode_7 = autonode_9.order_by(col('sr_return_amt_node_9'))
autonode_6 = autonode_8.add_columns(lit("hello"))
autonode_5 = autonode_7.alias('nxtvp')
autonode_4 = autonode_5.join(autonode_6, col('w_gmt_offset_node_10') == col('sr_store_credit_node_9'))
autonode_3 = autonode_4.group_by(col('w_street_number_node_10')).select(col('w_zip_node_10').min.alias('w_zip_node_10'))
autonode_2 = autonode_3.filter(col('w_zip_node_10').char_length >= 5)
autonode_1 = autonode_2.limit(95)
sink = autonode_1.alias('I9TUi')
print(sink.explain())
...
"""
{
  ...
  "result_details": {
    "opt": {
      ...
      "error_message": "An error occurred while calling o60070552.explain.
: java.lang.RuntimeException: Error while applying rule FlinkExpandConversionRule, args [rel#120643428:AbstractConverter.BATCH_PHYSICAL.hash[0]true.[11](input=RelSubset#120643426,convention=BATCH_PHYSICAL,FlinkRelDistributionTraitDef=hash[0]true,sort=[11]), rel#120643425:BatchPhysicalLocalHashAggregate.BATCH_PHYSICAL.any.[11](input=RelSubset#120643424,groupBy=sr_store_credit,select=sr_store_credit)]
...
LogicalProject(I9TUi=[AS($0, _UTF-16LE'I9TUi')])
+- LogicalSort(fetch=[95])
   +- LogicalFilter(condition=[>=(CHAR_LENGTH($0), 5)])
      +- LogicalProject(w_zip_node_10=[$1])
         +- LogicalAggregate(group=[{24}], EXPR$0=[MIN($31)])
            +- LogicalJoin(condition=[=($33, $18)], joinType=[inner])
               :- LogicalProject(nxtvp=[AS($0, _UTF-16LE'nxtvp')], sr_return_time_sk_node_9=[$1], sr_item_sk_node_9=[$2], sr_customer_sk_node_9=[$3], sr_cdemo_sk_node_9=[$4], sr_hdemo_sk_node_9=[$5], sr_addr_sk_node_9=[$6], sr_store_sk_node_9=[$7], sr_reason_sk_node_9=[$8], sr_ticket_number_node_9=[$9], sr_return_quantity_node_9=[$10], sr_return_amt_node_9=[$11], sr_return_tax_node_9=[$12], sr_return_amt_inc_tax_node_9=[$13], sr_fee_node_9=[$14], sr_return_ship_cost_node_9=[$15], sr_refunded_cash_node_9=[$16], sr_reversed_charge_node_9=[$17], sr_store_credit_node_9=[$18], sr_net_loss_node_9=[$19])
...
Calc(select=[EXPR$0 AS I9TUi])
+- Limit(offset=[0], fetch=[95], global=[true])
   +- Exchange(distribution=[single])
      +- Limit(offset=[0], fetch=[95], global=[false])
         +- Calc(select=[EXPR$0], where=[>=(CHAR_LENGTH(EXPR$0), 5)])
            +- SortAggregate(isMerge=[false], groupBy=[w_street_number_node_10], select=[w_street_number_node_10, MIN(w_zip_node_10) AS EXPR$0])
               +- Calc(select=[nxtvp, sr_return_time_sk_node_9, sr_item_sk_node_9, sr_customer_sk_node_9, sr_cdemo_sk_node_9, sr_hdemo_sk_node_9, sr_addr_sk_node_9, sr_store_sk_node_9, sr_reason_sk_node_9, sr_ticket_number_node_9, sr_return_quantity_node_9, sr_return_amt_node_9, sr_return_tax_node_9, sr_return_amt_inc_tax_node_9, sr_fee_node_9, sr_return_ship_cost_node_9, sr_refunded_cash_node_9, sr_reversed_charge_node_9, sr_store_credit_node_9, sr_net_loss_node_9, w_warehouse_sk_node_10, w_warehouse_id_node_10, w_warehouse_name_node_10, w_warehouse_sq_ft_node_10, w_street_number_node_10, w_street_name_node_10, w_street_type_node_10, w_suite_number_node_10, w_city_node_10, w_county_node_10, w_state_node_10, w_zip_node_10, w_country_node_10, w_gmt_offset_node_10, 'hello' AS _c14])
                  +- Sort(orderBy=[w_street_number_node_10 ASC])
                     +- Exchange(distribution=[hash[w_street_number_node_10]])
                        +- NestedLoopJoin(joinType=[InnerJoin], where=[=(w_gmt_offset_node_100, sr_store_credit_node_9)], select=[nxtvp, sr_return_time_sk_node_9, sr_item_sk_node_9, sr_customer_sk_node_9, sr_cdemo_sk_node_9, sr_hdemo_sk_node_9, sr_addr_sk_node_9, sr_store_sk_node_9, sr_reason_sk_node_9, sr_ticket_number_node_9, sr_return_quantity_node_9, sr_return_amt_node_9, sr_return_tax_node_9, sr_return_amt_inc_tax_node_9, sr_fee_node_9, sr_return_ship_cost_node_9, sr_refunded_cash_node_9, sr_reversed_charge_node_9, sr_store_credit_node_9, sr_net_loss_node_9, w_warehouse_sk_node_10, w_warehouse_id_node_10, w_warehouse_name_node_10, w_warehouse_sq_ft_node_10, w_street_number_node_10, w_street_name_node_10, w_street_type_node_10, w_suite_number_node_10, w_city_node_10, w_county_node_10, w_state_node_10, w_zip_node_10, w_country_node_10, w_gmt_offset_node_10, w_gmt_offset_node_100], build=[left])
                           :- Exchange(distribution=[broadcast])
                           :  +- Calc(select=[sr_returned_date_sk AS nxtvp, sr_return_time_sk AS sr_return_time_sk_node_9, sr_item_sk AS sr_item_sk_node_9, sr_customer_sk AS sr_customer_sk_node_9, sr_cdemo_sk AS sr_cdemo_sk_node_9, sr_hdemo_sk AS sr_hdemo_sk_node_9, sr_addr_sk AS sr_addr_sk_node_9, sr_store_sk AS sr_store_sk_node_9, sr_reason_sk AS sr_reason_sk_node_9, sr_ticket_number AS sr_ticket_number_node_9, sr_return_quantity AS sr_return_quantity_node_9, sr_return_amt AS sr_return_amt_node_9, sr_return_tax AS sr_return_tax_node_9, sr_return_amt_inc_tax AS sr_return_amt_inc_tax_node_9, sr_fee AS sr_fee_node_9, sr_return_ship_cost AS sr_return_ship_cost_node_9, sr_refunded_cash AS sr_refunded_cash_node_9, sr_reversed_charge AS sr_reversed_charge_node_9, sr_store_credit AS sr_store_credit_node_9, sr_net_loss AS sr_net_loss_node_9])
                           :     +- SortLimit(orderBy=[sr_return_amt ASC], offset=[0], fetch=[1], global=[true])
                           :        +- Exchange(distribution=[single])
                           :           +- SortLimit(orderBy=[sr_return_amt ASC], offset=[0], fetch=[1], global=[false])
                           ...
                           +- Calc(select=[w_warehouse_sk AS w_warehouse_sk_node_10, w_warehouse_id AS w_warehouse_id_node_10, w_warehouse_name AS w_warehouse_name_node_10, w_warehouse_sq_ft AS w_warehouse_sq_ft_node_10, w_street_number AS w_street_number_node_10, w_street_name AS w_street_name_node_10, w_street_type AS w_street_type_node_10, w_suite_number AS w_suite_number_node_10, w_city AS w_city_node_10, w_county AS w_county_node_10, w_state AS w_state_node_10, w_zip AS w_zip_node_10, w_country AS w_country_node_10, w_gmt_offset AS w_gmt_offset_node_10, CAST(w_gmt_offset AS DECIMAL(7, 2)) AS w_gmt_offset_node_100])
