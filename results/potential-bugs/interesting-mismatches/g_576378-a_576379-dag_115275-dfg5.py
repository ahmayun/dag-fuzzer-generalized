...
autonode_6 = autonode_8.group_by(col('t_minute_node_10')).select(col('t_time_node_10').max.alias('t_time_node_10'))
autonode_5 = autonode_7.order_by(col('ws_ext_sales_price_node_9'))
autonode_4 = autonode_6.limit(39)
autonode_3 = autonode_5.alias('5Ugh8')
autonode_2 = autonode_3.join(autonode_4, col('ws_item_sk_node_9') == col('t_time_node_10'))
autonode_1 = autonode_2.group_by(col('ws_ship_cdemo_sk_node_9')).select(col('ws_warehouse_sk_node_9').max.alias('ws_warehouse_sk_node_9'))
...
+- LogicalAggregate(group=[{9}], EXPR$0=[MAX($15)])
   +- LogicalJoin(condition=[=($3, $35)], joinType=[inner])
      ...
      +- LogicalSort(fetch=[39])
         +- LogicalProject(t_time_node_10=[$1])
            +- LogicalAggregate(group=[{4}], EXPR$0=[MAX($2)])
      ...
      +- LocalHashAggregate(groupBy=[ws_ship_cdemo_sk_node_9], select=[ws_ship_cdemo_sk_node_9, Partial_MAX(ws_warehouse_sk_node_9) AS max$0])
         +- HashJoin(joinType=[InnerJoin], where=[=(ws_item_sk_node_9, t_time_node_10)], select=[5Ugh8, ws_sold_time_sk_node_9, ws_ship_date_sk_node_9, ws_item_sk_node_9, ws_bill_customer_sk_node_9, ws_bill_cdemo_sk_node_9, ws_bill_hdemo_sk_node_9, ws_bill_addr_sk_node_9, ws_ship_customer_sk_node_9, ws_ship_cdemo_sk_node_9, ws_ship_hdemo_sk_node_9, ws_ship_addr_sk_node_9, ws_web_page_sk_node_9, ws_web_site_sk_node_9, ws_ship_mode_sk_node_9, ws_warehouse_sk_node_9, ws_promo_sk_node_9, ws_order_number_node_9, ws_quantity_node_9, ws_wholesale_cost_node_9, ws_list_price_node_9, ws_sales_price_node_9, ws_ext_discount_amt_node_9, ws_ext_sales_price_node_9, ws_ext_wholesale_cost_node_9, ws_ext_list_price_node_9, ws_ext_tax_node_9, ws_coupon_amt_node_9, ws_ext_ship_cost_node_9, ws_net_paid_node_9, ws_net_paid_inc_tax_node_9, ws_net_paid_inc_ship_node_9, ws_net_paid_inc_ship_tax_node_9, ws_net_profit_node_9, _c34, t_time_node_10], isBroadcast=[true], build=[right])
            ...
            +- Exchange(distribution=[broadcast])
               +- Calc(select=[EXPR$0 AS t_time_node_10])
                  +- Limit(offset=[0], fetch=[39], global=[true])
                     +- Exchange(distribution=[single])
                        +- Limit(offset=[0], fetch=[39], global=[false])
                           +- HashAggregate(isMerge=[true], groupBy=[t_minute], select=[t_minute, Final_MAX(max$0) AS EXPR$0])
                              +- Exchange(distribution=[hash[t_minute]])
                                 +- LocalHashAggregate(groupBy=[t_minute], select=[t_minute, Partial_MAX(t_time) AS max$0])
...
",
    ...
    "unopt": {
      ...
      "error_message": "An error occurred while calling o314342592.explain.
: java.lang.RuntimeException: Error while applying rule FlinkExpandConversionRule, args [rel#633625580:AbstractConverter.BATCH_PHYSICAL.hash[0, 1]true.[23](input=RelSubset#633625578,convention=BATCH_PHYSICAL,FlinkRelDistributionTraitDef=hash[0, 1]true,sort=[23]), rel#633625577:BatchPhysicalLocalHashAggregate.BATCH_PHYSICAL.any.[23](input=RelSubset#633625576,groupBy=ws_item_sk, ws_ship_cdemo_sk,select=ws_item_sk, ws_ship_cdemo_sk, Partial_MAX(ws_warehouse_sk) AS max$0)]
