...
autonode_3 = autonode_5.join(autonode_6, col('r_reason_id_node_5') == col('c_salutation_node_6'))
autonode_4 = autonode_7.order_by(col('cd_dep_college_count_node_7'))
autonode_2 = autonode_3.join(autonode_4, col('cd_credit_rating_node_7') == col('c_first_name_node_6'))
autonode_1 = autonode_2.group_by(col('c_last_review_date_node_6')).select(col('r_reason_id_node_5').max.alias('r_reason_id_node_5'))
sink = autonode_1.alias('JQudV')
print(sink.explain())
...
"""
{
  ...
  "result_details": {
    "opt": {
      ...
      "error_message": "An error occurred while calling o66915329.explain.
: java.lang.RuntimeException: Error while applying rule FlinkExpandConversionRule, args [rel#134152834:AbstractConverter.BATCH_PHYSICAL.hash[0]true.[8](input=RelSubset#134152832,convention=BATCH_PHYSICAL,FlinkRelDistributionTraitDef=hash[0]true,sort=[8]), rel#134152831:BatchPhysicalLocalHashAggregate.BATCH_PHYSICAL.any.[8](input=RelSubset#134152830,groupBy=cd_credit_rating,select=cd_credit_rating)]
...
LogicalProject(JQudV=[AS($1, _UTF-16LE'JQudV')])
+- LogicalAggregate(group=[{20}], EXPR$0=[MAX($1)])
   +- LogicalJoin(condition=[=($26, $11)], joinType=[inner])
