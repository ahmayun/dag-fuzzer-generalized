...
autonode_4 = autonode_6.limit(67)
autonode_3 = autonode_5.order_by(col('cd_gender_node_5'))
autonode_2 = autonode_3.join(autonode_4, col('ws_order_number_node_6') == col('cd_dep_count_node_5'))
autonode_1 = autonode_2.filter(col('ws_ext_sales_price_node_6') < 23.4704852104187)
sink = autonode_1.group_by(col('ws_ship_hdemo_sk_node_6')).select(col('ws_quantity_node_6').max.alias('ws_quantity_node_6'))
print(sink.explain())
...
"""
{
  ...
  "result_details": {
    "opt": {
      ...
      "error_message": "An error occurred while calling o244198738.explain.
: java.lang.RuntimeException: Error while applying rule FlinkExpandConversionRule, args [rel#493948091:AbstractConverter.BATCH_PHYSICAL.hash[0]true.[1](input=RelSubset#493948089,convention=BATCH_PHYSICAL,FlinkRelDistributionTraitDef=hash[0]true,sort=[1]), rel#493948088:BatchPhysicalLocalHashAggregate.BATCH_PHYSICAL.any.[1](input=RelSubset#493948087,groupBy=cd_dep_count,select=cd_dep_count)]
...
LogicalProject(ws_quantity_node_6=[$1])
+- LogicalAggregate(group=[{19}], EXPR$0=[MAX($27)])
   +- LogicalFilter(condition=[<($32, 2.34704852104187E1:DOUBLE)])
      +- LogicalJoin(condition=[=($26, $6)], joinType=[inner])
         :- LogicalSort(sort0=[$1], dir0=[ASC])
         :  +- LogicalProject(cd_demo_sk_node_5=[$0], cd_gender_node_5=[$1], cd_marital_status_node_5=[$2], cd_education_status_node_5=[$3], cd_purchase_estimate_node_5=[$4], cd_credit_rating_node_5=[$5], cd_dep_count_node_5=[$6], cd_dep_employed_count_node_5=[$7], cd_dep_college_count_node_5=[$8])
...
Calc(select=[EXPR$0 AS ws_quantity_node_6])
+- SortAggregate(isMerge=[true], groupBy=[ws_ship_hdemo_sk], select=[ws_ship_hdemo_sk, Final_MAX(max$0) AS EXPR$0])
   +- Sort(orderBy=[ws_ship_hdemo_sk ASC])
      +- Exchange(distribution=[hash[ws_ship_hdemo_sk]])
         +- LocalSortAggregate(groupBy=[ws_ship_hdemo_sk], select=[ws_ship_hdemo_sk, Partial_MAX(ws_quantity) AS max$0])
            +- Sort(orderBy=[ws_ship_hdemo_sk ASC])
               +- NestedLoopJoin(joinType=[InnerJoin], where=[=(ws_order_number, cd_dep_count)], select=[cd_demo_sk, cd_gender, cd_marital_status, cd_education_status, cd_purchase_estimate, cd_credit_rating, cd_dep_count, cd_dep_employed_count, cd_dep_college_count, ws_sold_date_sk, ws_sold_time_sk, ws_ship_date_sk, ws_item_sk, ws_bill_customer_sk, ws_bill_cdemo_sk, ws_bill_hdemo_sk, ws_bill_addr_sk, ws_ship_customer_sk, ws_ship_cdemo_sk, ws_ship_hdemo_sk, ws_ship_addr_sk, ws_web_page_sk, ws_web_site_sk, ws_ship_mode_sk, ws_warehouse_sk, ws_promo_sk, ws_order_number, ws_quantity, ws_wholesale_cost, ws_list_price, ws_sales_price, ws_ext_discount_amt, ws_ext_sales_price, ws_ext_wholesale_cost, ws_ext_list_price, ws_ext_tax, ws_coupon_amt, ws_ext_ship_cost, ws_net_paid, ws_net_paid_inc_tax, ws_net_paid_inc_ship, ws_net_paid_inc_ship_tax, ws_net_profit], build=[left])
                  ...
                  +- Calc(select=[ws_sold_date_sk, ws_sold_time_sk, ws_ship_date_sk, ws_item_sk, ws_bill_customer_sk, ws_bill_cdemo_sk, ws_bill_hdemo_sk, ws_bill_addr_sk, ws_ship_customer_sk, ws_ship_cdemo_sk, ws_ship_hdemo_sk, ws_ship_addr_sk, ws_web_page_sk, ws_web_site_sk, ws_ship_mode_sk, ws_warehouse_sk, ws_promo_sk, ws_order_number, ws_quantity, ws_wholesale_cost, ws_list_price, ws_sales_price, ws_ext_discount_amt, ws_ext_sales_price, ws_ext_wholesale_cost, ws_ext_list_price, ws_ext_tax, ws_coupon_amt, ws_ext_ship_cost, ws_net_paid, ws_net_paid_inc_tax, ws_net_paid_inc_ship, ws_net_paid_inc_ship_tax, ws_net_profit], where=[<(ws_ext_sales_price, 2.34704852104187E1)])
                     +- Limit(offset=[0], fetch=[67], global=[true])
                        +- Exchange(distribution=[single])
                           +- Limit(offset=[0], fetch=[67], global=[false])
                              +- TableSourceScan(table=[[default_catalog, default_database, web_sales, limit=[67]]], fields=[ws_sold_date_sk, ws_sold_time_sk, ws_ship_date_sk, ws_item_sk, ws_bill_customer_sk, ws_bill_cdemo_sk, ws_bill_hdemo_sk, ws_bill_addr_sk, ws_ship_customer_sk, ws_ship_cdemo_sk, ws_ship_hdemo_sk, ws_ship_addr_sk, ws_web_page_sk, ws_web_site_sk, ws_ship_mode_sk, ws_warehouse_sk, ws_promo_sk, ws_order_number, ws_quantity, ws_wholesale_cost, ws_list_price, ws_sales_price, ws_ext_discount_amt, ws_ext_sales_price, ws_ext_wholesale_cost, ws_ext_list_price, ws_ext_tax, ws_coupon_amt, ws_ext_ship_cost, ws_net_paid, ws_net_paid_inc_tax, ws_net_paid_inc_ship, ws_net_paid_inc_ship_tax, ws_net_profit])
