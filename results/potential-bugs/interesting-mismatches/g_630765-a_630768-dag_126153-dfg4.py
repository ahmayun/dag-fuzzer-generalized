...
autonode_9 = autonode_12.filter(col('d_current_year_node_12').char_length <= 5)
autonode_8 = autonode_11.filter(col('wp_autogen_flag_node_11').char_length < 5)
autonode_7 = autonode_10.alias('aHfwI')
autonode_6 = autonode_9.order_by(col('d_qoy_node_12'))
autonode_5 = autonode_8.add_columns(lit("hello"))
autonode_4 = autonode_6.join(autonode_7, col('d_current_month_node_12') == col('p_channel_radio_node_13'))
autonode_3 = autonode_5.add_columns(lit("hello"))
autonode_2 = autonode_4.group_by(col('d_quarter_seq_node_12')).select(col('p_channel_radio_node_13').min.alias('p_channel_radio_node_13'))
autonode_1 = autonode_3.order_by(col('wp_rec_end_date_node_11'))
sink = autonode_1.join(autonode_2, col('p_channel_radio_node_13') == col('wp_web_page_id_node_11'))
print(sink.explain())
